...
WebUI.callTestCase(findTestCase('API Test Cases/Rest API/Get User Details'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.sendKeys(findTestObject('Web Object Repository/CURA Healthcare Service/Login Page/input_Username'), findTestData('null').getValue(
        'DBusername', 1))

WebUI.sendKeys(findTestObject('Web Object Repository/CURA Healthcare Service/Login Page/input_Password'), findTestData('null').getValue(
        'DBpassword', 1))
